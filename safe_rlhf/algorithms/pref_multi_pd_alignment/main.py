...
# ==============================================================================
"""The main training script to run the preference-based PD alignment algorithm."""
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        prog='deepspeed --module safe_rlhf.algorithms.pref_multi_pd_alignment',
        description='Train language model with the preference-based PD alignment algorithm.',
...
def main() -> None:
    ...
    trainer = PrefMultiPdAlignmentTrainer(args, ds_train_config, ds_eval_config)
    trainer.train()
    trainer.save()
