...
def parse_arguments() -> argparse.Namespace:  # noqa: D401
    parser = argparse.ArgumentParser(
        prog='deepspeed --module safe_rlhf.algorithms.pubmedqa',
        description='Supervised fine-tuning on PubMedQA (yes / no / maybe).',
    ...
    model_group.add_argument('--reference_model_name_or_path', type=str, default=None,
                             help='Optional path/name for the language model used only for KL regularisation. '
    ...
    # Regularization ---------------------------------------------------------
    train_group.add_argument('--kl_coef', type=float, default=0.01,
                             help='Coefficient for KL divergence regularization w.r.t. the '
...
def main() -> None:  # noqa: D401
    ...
    # This will initialize torch.distributed and set the default process group.
    ...
    # Launch trainer ----------------------------------------------------------
    trainer = PubMedQATrainer(args, ds_config)
    trainer.train()
