...
from safe_rlhf.values.classifier.trainer import MultiClassTrainer


def parse_arguments() -> argparse.Namespace:
    """Parse the command-line arguments."""
    parser = argparse.ArgumentParser(
        prog='deepspeed --module safe_rlhf.values.classifier',
    ...
    dataset_parser.add_argument(
        '--eval_datasets',
        type=str,
        help='The evaluation dataset path.',
    )
    dataset_parser.add_argument(
        '--num_labels',
        type=int,
        default=5,
        help='The number of labels in the dataset. TODO: remove this argument and infer it from the dataset.',
    )
    # Training
...
def main() -> None:
    ...
    trainer = MultiClassTrainer(args, ds_config)
    # trainer.eval()
    trainer.train()
    trainer.save()
